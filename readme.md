...
This Harbour MiniGUI package includes these main components:   
   ...
   - Harbour MiniGUI Extended version 18.06
     ( http://hmgextended.com/home.html/ )   
     (compiled with Harbour 3.4.0dev & MinGW 8.1.0)   

   - Harbour 3.4.0dev Harbour compiler and runtime libraries   
       (https://github.com/vszakats/harbour-core)   
       (binaries built with MinGW32 8.1.0) 

   - MinGW32 v. 8.1.0 (Built by MinGW-W64 project)   
