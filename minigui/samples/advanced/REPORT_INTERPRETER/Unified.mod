...
@8,14 print image rosa.jpg width 35 height 35
if (owr:prndrv="MINI")
   @(lstep),105 SAY [INFORME DE ARTISTAS DE CINE] FONT ARIAL SIZE 16 BOLD ITALIC align center
   @(2*lstep)+1,105 SAY [Segundo titulo] FONT ARIAL SIZE 16 BOLD ITALIC align center
Else
...
if (owr:prndrv="MINI")
   @(62*lstep)-3,35 SAY (Pizza) font [COURIER NEW] SIZE 20 BOLD
Else
   @(62*lstep),35 SAY (Pizza) font [COURIER NEW] SIZE 20 BOLD
Endif
*MSGBOX(61*lstep,"LSTEPT")
