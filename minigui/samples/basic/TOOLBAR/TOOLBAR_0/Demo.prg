	...
	DEFINE WINDOW Form_1 ;
		...
		DEFINE MAIN MENU 
			POPUP '&File'
				...
				SEPARATOR
				ITEM 'Get ToolBar Button_1 ICON' ACTION MsgInfo( GetProperty( 'Form_1', 'Button_1', 'Picture' ) )
				ITEM 'Set ToolBar Button_1 ICON' ACTION Change_Button_1_Icon( @cPicture )
				SEPARATOR
		...
		DEFINE TOOLBAR ToolBar_1 BUTTONSIZE 90,85 FLAT BORDER SIZE 9 
...
PROCEDURE Change_Button_1_Icon( /*@*/ cPicture )

	LOCAL cOldPicture := GetProperty( 'Form_1', 'Button_1', 'Picture' )
	
	IF Empty( cPicture )
		cPicture := 'HMG.png'
	ENDIF
	
	SetProperty( 'Form_1', 'Button_1', 'Picture', cPicture )
	
	cPicture := cOldPicture
