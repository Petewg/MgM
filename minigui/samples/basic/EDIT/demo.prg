...
Function AdvTest()
        ...
        MsgInfo( "This sample show advanced features of EDIT." + Chr(13) + Chr(13) +;
                 ...
                 "Spanish language for better performance", "Advise" )
        HB_LANGSELECT( "ES" )
...
Procedure SelecLang()
        ...
        nItem := SelItem( aLangName, aLangID )
        IF .NOT. nItem == 0
...
/*-----------------------------------------------------------------------------*/
Function SelItem( aItems, aLangs )
        ...
        wndSelItem.lbxItems.Value := Ascan( aLangs, {|lang| Lower( Left( lang, 2 ) ) == Left( Set( _SET_LANGUAGE ), 2 )} )
...
Procedure About()
        ...
        MsgInfo( Chr( 13 ) + ;
                 ...
                 " *  Ukranian   - Ready (Thanks to Vladimir Chumachenko)" + Chr( 13 ) + ;
