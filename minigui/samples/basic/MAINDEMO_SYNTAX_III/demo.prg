	...
	DEFINE WINDOW Form_1 ;
		...
		DEFINE MAIN MENU 
			...
			POPUP 'M&isc'
				...
				ITEM 'Get Control Height Property' 	ACTION 	( FETCH Button_1 OF Form_1 HEIGHT TO TmpVar , MsgInfo ( Str ( TmpVar ) ) )
				SEPARATOR
				...
				ITEM 'Set Control Height Property' 	ACTION MODIFY Button_1 OF Form_1 HEIGHT 50
				SEPARATOR
				...
				ITEM 'Set Window Height Property' 	ACTION Form_1.HEIGHT := 400
				SEPARATOR
				...
				ITEM 'Get Window Height Property' 	ACTION ( TmpVar := Form_1.HEIGHT , MsgInfo ( Str ( TmpVar ) ) )
				SEPARATOR
