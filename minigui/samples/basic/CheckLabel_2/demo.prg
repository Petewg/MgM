...
Function Main
   ...
   DEFINE WINDOW Form_Main ;
      ...
      @ 40,50 BUTTON Btn1 ;
         ...
         WIDTH 120 DEFAULT ;
         ACTION Form_Main.Label_2.Value := .T.

      @ 80,50 BUTTON Btn2 ;
         CAPTION "Uncheck Label_2" ;
         WIDTH 120 ;
         ACTION Form_Main.Label_2.Value := .F.
...
PROCEDURE RadioItem_Click( CheckName )
   ...
   SetProperty( 'Form_Main', CheckName, 'Value', .T. )
   InkeyGUI(250)
   Form_Main.Label_3.Value := .F.
   Form_Main.Label_4.Value := .F.
   Form_Main.Label_5.Value := .F.
   Form_Main.Label_6.Value := .F.
   SetProperty( 'Form_Main', CheckName, 'Value', .T. )
...
Local nValue
   ...
   DO CASE
	CASE Form_Main.Label_3.Value == .T.
		nValue := 1
	CASE Form_Main.Label_4.Value == .T.
		nValue := 2
	CASE Form_Main.Label_5.Value == .T.
		nValue := 3
	CASE Form_Main.Label_6.Value == .T.
		nValue := 4
	OTHERWISE
		nValue := 0
   END CASE
