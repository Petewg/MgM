...
fColor := { || if ( This.CellRowIndex/2 == int(This.CellRowIndex/2) , { 255,0,0 } , { 0,0,255 } ) }
	...
	aRows [1]	:= {1,'Simpson',1500.00,ctod('23/05/1989'),.t.,date(),12}
	aRows [2]	:= {2,'Mulder',2000.00,ctod('12/06/1989'),.f.,date(),15}
   /*
...
local aItems, i, aMonths := {"January","February","March","April","May","June","July","August","September","October","November","December"}
...
if iscontroldefined(oGrid,oWindow)
   ...
   if lmultiselect
	...
	Define Grid oGrid
		...
		ColumnControls	{   {"COMBOBOX", aMonths },{'TEXTBOX','CHARACTER'},;
