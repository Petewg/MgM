...
#translate ControlHandle ( <ControlName> , <FormName> ) => GetControlHandle ( <"ControlName"> , <"FormName"> )
#translate ControlIndex ( <ControlName> , <FormName> ) => GetControlIndex ( <"ControlName"> , <"FormName"> )
#translate ColumnsWidthAutoH ( <ControlName> , <FormName> ) => _SetColumnsWidthAutoH( <"ControlName"> , <"FormName"> )
...
LOCAL hGrid, nWidth := 0
   ...
   AEval(aItems, {|a,n| nWidth := Max(nWidth, GetTxtWidth(a[1]+repl('W', 7), nFontSize, cFontName)) })
