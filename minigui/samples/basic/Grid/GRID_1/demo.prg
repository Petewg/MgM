	...
	DEFINE WINDOW Form_1 ;
		...
		DEFINE MAIN MENU 
			POPUP '&Test'
				...
				SEPARATOR
				ITEM 'Get Current Row of Grid 2 Third Column Value'	ACTION MsgInfo( Form_1.Grid_2.Cell(GetProperty("Form_1","Grid_2", 'Value'), 2) )
...
PROCEDURE ChangeItems()
LOCAL aRows :=  {{'??????','????????','???-????'},  {'111111','111111111','111-111'}}
LOCAL e
Form_1.Grid_2.DeleteAllItems()

for each e IN aRows
	DoMethod( "Form_1" , "Grid_2" , 'AddItem' , e )
next
RETURN
