	...
	DEFINE WINDOW Form_1 ;
		...
		DEFINE MAIN MENU
			...
			POPUP 'Picture Property Test'
				ITEM 'Set Button 1 Picture' ACTION Form_1.Button_1.Picture := 'button5.ICO'
				ITEM 'Get Button 1 Picture' ACTION MsgInfo( Form_1.Button_1.Picture )
				SEPARATOR
				ITEM 'Set Button 2 Picture' ACTION Form_1.Button_2.Picture := 'button5.ICO'
				ITEM 'Get Button 2 Picture' ACTION MsgInfo( Form_1.Button_2.Picture )
				SEPARATOR
				ITEM 'Set Button 3 Picture' ACTION Form_1.Button_3.Picture := 'button5.ICO'
				ITEM 'Get Button 3 Picture' ACTION MsgInfo( Form_1.Button_3.Picture )
				SEPARATOR
				ITEM 'Set Button 4 Picture' ACTION Form_1.Button_4.Picture := 'button5.ICO'
				ITEM 'Get Button 4 Picture' ACTION MsgInfo( Form_1.Button_4.Picture )
				SEPARATOR
				ITEM 'Set Button 5 Picture' ACTION Form_1.Button_5.Picture := 'button5.ICO'
				ITEM 'Get Button 5 Picture' ACTION MsgInfo( Form_1.Button_5.Picture )
				SEPARATOR
				ITEM 'Set Button 6 Picture' ACTION Form_1.Button_6.Picture := 'button5.ICO'
				ITEM 'Get Button 6 Picture' ACTION MsgInfo( Form_1.Button_6.Picture )
				SEPARATOR
				ITEM 'Set Button 7 Picture' ACTION Form_1.Button_7.Picture := 'button5.ICO'
				ITEM 'Get Button 7 Picture' ACTION MsgInfo( Form_1.Button_7.Picture )
				SEPARATOR
				ITEM 'Set Button 8 Picture' ACTION Form_1.Button_8.Picture := 'button5.ICO'
