...
HB_FUNC( SUPPRESSKEYANDMOUSEEVENTS )
{
   ...
   while( PeekMessage( &msg, NULL, WM_MOUSEFIRST, WM_MOUSELAST, PM_REMOVE ) ); // clean all mouse clicks
   while( PeekMessage( &msg, NULL, WM_KEYFIRST  , WM_KEYLAST  , PM_REMOVE ) ); // clean all keybrd clicks
