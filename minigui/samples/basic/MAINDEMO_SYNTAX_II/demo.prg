	...
	DEFINE WINDOW Form_1 ;
		...
		DEFINE MAIN MENU 
			...
			POPUP 'M&isc'
				...
				ITEM 'Get Control Height Property' 	ACTION 	MsgInfo ( Str ( GetProperty ('Form_1','Button_1','Height')   ) , 'Maximize Button' )
				SEPARATOR
				...
				ITEM 'Set Control Height Property' 	ACTION SetProperty ('Form_1','Button_1','Height', 50 )
				SEPARATOR
				...
				ITEM 'Set Window Height Property' 	ACTION SetProperty ('Form_1','Height' 	, 400)
				SEPARATOR
				...
				ITEM 'Get Window Height Property' 	ACTION MsgInfo ( Str ( GetProperty ('Form_1','Height') ) )
				SEPARATOR
