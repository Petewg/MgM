...
*------------------------------------------------------------------------------*
   ...
   CASE cLang == "UK" .OR. cLang == "UA"  // Ukrainian
      ...
      _HMG_MESSAGE[ 4 ] := ( 'Програма виконується.' + CRLF + ;
         'Запуск ще однiєї копiї заборонено.' )
   ...
   CASE cLang == "EL"  // Greek - Ellinika
      ...
      // MISC MESSAGES (EL - GREEK - ЕЛЛЗНЙКБ)
      ...
      // BROWSE MESSAGES (EL - GREEK - ЕЛЛЗНЙКБ)
      _HMG_BRWLangButton := { ;
		   "&РспуиЮкз"        , ;
         "&Дйьсищуз"        , ;
         "&Бкхсп"           , ;
      ...
      // EDIT MESSAGES  (EL - GREEK - ЕЛЛЗНЙКБ)
      _HMG_aABMLangUser   := { ;
		   Chr( 13 ) + "ДйбгсбцЮ еггсбцЮт" + Chr( 13 ) + "ЕЯуфе вЭвбйпй?" + Chr( 13 )                    , ;
         Chr( 13 ) + "Фп ехсефЮсйп ден хрЬсчей" + Chr( 13 ) + "БнбжЮфзуз бдэнбфз!" + Chr( 13 )         , ;
         Chr( 13 ) + "Фп клейдЯ бнбжЮфзузт ден всЭизке" + Chr( 13 ) + "БнбжЮфзуз бдэнбфз!" + Chr( 13 ) , ;
         Chr( 13 ) + "БнбжЮфзуз бдэнбфз уе" + Chr( 13 ) + "редЯб memo Ю лпгйкЬ" + Chr( 13 )            , ;
         Chr( 13 ) + "З еггсбцЮ ден всЭизке" + Chr( 13 )                                               , ;
         Chr( 13 ) + "РпллЭт уфЮлет" + Chr( 13 ) + "З екфэрщуз ден чщсЬ уфз уелЯдб" + Chr( 13 ) }
      ...
      _HMG_aABMLangError  := { ;
		   "ЕРЕОЕСГБУЙБ, фп ьнпмб ресйпчзт есгбуйбт ден хрбсчей"                           , ;
      ...
      // EDIT EXTENDED  (EL - GREEK - ЕЛЛЗНЙКБ)
      _HMG_aLangButton := { ;
			"&КлеЯуймп",       ; // 1
			"&НЭп",            ; // 2
			"&Дйьсищуз",       ; // 3
      ...
      _HMG_aLangUser := { ;
			CRLF + "Ден хрЬсчей енесгЮ ресйпчЮ есгбуЯбт. "  + CRLF + "ЕрйлЭофе мйЬ ресйпчЮ рсЯн брь фзн клЮуз фзт EDIT   " + CRLF, ; // 1
			"Дюуфе мЯб фймЮ редЯпх (кеЯменп)",                                                                         ; // 2
			"Дюуфе мЯб фймЮ редЯпх (бсйимьт)",                                                                         ; // 3
			"ЕрйлЭофе змес/нЯб",                                                                                       ; // 4
			"ФуекЬсефе нб блзиеэей",                                                                                   ; // 5
			...
			"РйЭуфе фп кпхмрЯ гйЬ ерйлпгЮ фзт еггсбцзт гйб екфхрщуз",                                                  ; // 17
			"РйЭуфе фп кпхмрЯ гйЬ ерйлпгЮ фелехфбЯбт еггсбцЮт",                                                        ; // 18
			...
			CRLF + "Иб гЯней ербнбцпсЬ фзт дйбгсбммЭнзт еггсбцЮт  " + CRLF + "ЕЯуфе вЭвбйпй?   " + CRLF }                // 42
