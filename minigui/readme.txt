...
Copyright (c) 2005-2017 MiniGUI Team. All rights reserved.
...
Note that you can use also optional the MinGW, Open Watcom or Pelles C compilers.
...
There is also the 64-bit MinGW-based MiniGUI build which is used the MinGW
compiler built by MinGW-W64 project at http://sourceforge.net/projects/mingw-w64.
...
The parts of this project are based upon:
   ...
   "HWGUI"
   Copyright 2001-2017 Alexander S.Kresin <alex@belacy.ru>
