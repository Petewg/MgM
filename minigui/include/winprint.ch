...
#xcommand GET BINS TO <a_bins_numbers> =>  <a_bins_numbers>:=aclone(hbprn:binnames)
...
#xcommand GET CLOSEPREVIEW TO <status> => <status>:=hbprn:clspreview
#xcommand GET ESCAPE STATUS TO <status> => <status>:=hbprn:lescaped
