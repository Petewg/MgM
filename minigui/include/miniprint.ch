...
=> ;
iif ( _hmg_printer_preview , ( _hmg_printer_hdc := _HMG_PRINTER_STARTPAGE_PREVIEW ( _hmg_printer_hdc_bak , GetTempFolder() + "\" + _hmg_printer_timestamp + "_hmg_print_preview_" + strzero(++_hmg_printer_PageCount,4) + ".Emf" ) ) , _HMG_PRINTER_StartPage ( _hmg_printer_hdc ) )

#xcommand END PRINTPAGE ;
=> ;
iif ( _hmg_printer_preview , _HMG_PRINTER_ENDPAGE_PREVIEW (_hmg_printer_hdc) , _HMG_PRINTER_EndPage ( _hmg_printer_hdc ) )
